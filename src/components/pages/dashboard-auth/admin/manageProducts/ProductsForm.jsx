import { Button, TextField, formLabelClasses } from "@mui/material";
...
//       const resizedUrl = await uploadFile(selectedFile);
...
//         try {
//           const imageUrlPromises = selectedFiles.map(async (selectedFile) => {
//             return await handleImageUpload(selectedFile);
//           });
...
//             setSelectedItem((prevSelectedItem) => {
//               const imgCopy = [...(prevSelectedItem.img || [])];
//               imgCopy[inputNumber - 1] = newUrls[0]; // Correct slot for 1-based index
//               return {
//                 ...prevSelectedItem,
//                 img: imgCopy,
//               };
...
//           setImageQueue((prevQueue) => {
//             const updatedQueue = [...prevQueue];
//             updatedQueue.splice(processedItemIndex, 1); // Use splice to remove the item
//             return updatedQueue;
//           });
//         }
//       } else {
...
//     // Call handleImageQueue initially
//     handleImageQueue();
//   }, [imageQueue, uploadFile, existingImages]);
...
//                             <img
//                               src={
//                                 imageUrls[slotIndex].length > 0
//                                   ? URL.createObjectURL(imageUrls[slotIndex][0])
//                                   : ""
//                               }
//                               alt={
//                                 imageUrls[slotIndex].length > 0
